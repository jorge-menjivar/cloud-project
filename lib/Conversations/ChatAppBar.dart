...
class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    var textHeading = TextStyle(
        color: Colors.blue[50], fontSize: 20); // Text style for the name
    var textStyle = TextStyle(
        color: Colors
            .grey); //Palette.secondaryTextColor); // Text style for everything else
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    mainAxisSize: MainAxisSize.min,
                                    children: <Widget>[
                                      Text('Ashley', style: textHeading),
                                      Text('@Ashley', style: textStyle)
                                    ],
                                  ))),
                            ],
                          )),
